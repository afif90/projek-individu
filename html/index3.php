            ...
            <div class="side_menu_bottom">
                <div class="side_menu_bottom_inner">
                    ...
                    <div class="copy_right">
                        ...
                        <p class="copyright">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Cocopandan</a></p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="grid img-container justify-content-center no-gutters">
                        ...
                        <div class="grid-item  design col-sm-12 col-md-6 col-lg-3">
                            <a href="assets/img/portfolio/home-port3.png" title="project name 3">
                                <div class="project_box_one">
                        ...
                        <div class="grid-item  photography design col-sm-12 col-md-6 col-lg-3">
                            <a href="assets/img/portfolio/home-port4.png" title="project name 4">
                                <div class="project_box_one">
                        ...
                        <div class="grid-item   architecture design col-sm-12 col-md-6 col-lg-3">
                            <a href="assets/img/portfolio/home-port2.png" title="project name 6">
                                <div class="project_box_one">
                        ...
                        <div class="grid-item  photography architecture col-sm-12 col-md-6 col-lg-3">
                            <a href="assets/img/portfolio/port1.png" title="project name 7">
                                <div class="project_box_one">
                        ...
                        <div class="grid-item architecture  col-sm-12 col-md-6 col-lg-6">
                            <a href="assets/img/portfolio/home-port9.png" title="project name 9">
                                <div class="project_box_one">
